...
use IO::Compress::Base 2.029 ;
use IO::Compress::Base::Common  2.029 qw(createSelfTiedObject);
use IO::Compress::Adapter::Xz 2.020 ;
use Compress::Raw::Lzma  2.029 ;
...
sub getExtraParams
{
    ...
    use IO::Compress::Base::Common  2.029 qw(:Parse);
    use Compress::Raw::Lzma 2.029 qw(LZMA_PRESET_DEFAULT LZMA_CHECK_CRC32) ;
