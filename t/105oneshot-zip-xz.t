...
BEGIN {
    ...
    plan(skip_all => "IO::Compress::Xz not available" )
        unless eval { require IO::Compress::Xz;
    ...
    use_ok('IO::Compress::Zip::Constants', 'ZIP_CM_XZ');
...

{
    ...
    my $zipfile = 't/files/winzip-eq-xz.zip';
    my $method = ZIP_CM_XZ;
