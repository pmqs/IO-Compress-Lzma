...
use IO::Compress::Base 2.028 ;
use IO::Compress::Base::Common  2.028 qw(createSelfTiedObject);
use IO::Compress::Adapter::Xz 2.020 ;
use Compress::Raw::Lzma  2.028 ;
...
sub getExtraParams
{
    ...
    use IO::Compress::Base::Common  2.028 qw(:Parse);
    use Compress::Raw::Lzma 2.028 qw(LZMA_PRESET_DEFAULT LZMA_CHECK_CRC32) ;
